...
class SendReceiveTab extends StatefulWidget {
  static const title = 'Send / Receive';
  static const androidIcon = Icon(Icons.sync_alt);
  static const iosIcon = Icon(CupertinoIcons.arrow_right_arrow_left);

  const SendReceiveTab({Key? key}) : super(key: key);

  @override
  _SendReceiveTabState createState() => _SendReceiveTabState();
}

class _SendReceiveTabState extends State<SendReceiveTab> {
